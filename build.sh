...
MAKE_CONFIG="make ARCH=arm CROSS_COMPILE=$PANDA_CROSS_COMPILE panda_defconfig O=$BUILD_PATH"
...
MAKE_MODULES="make ARCH=arm CROSS_COMPILE=$PANDA_CROSS_COMPILE O=$BUILD_PATH INSTALL_MOD_PATH=$OUTPUT_PATH modules_install"
